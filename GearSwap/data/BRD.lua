...
function user_setup()
    ...
    state.InstrumentMode = M{['description']='Instrument Mode', 'Gjallarhorn', 'Daurdabla'}
...
function init_gear_sets()
    ...
    sets.midcast.Ballad = {legs="Fili Rhing. +1"}
    ...
    sets.midcast.Carol = {head="Fili' Calot +1",
        ...
        legs="Fili Rhing. +1",feet="Fili Cothrn. +1"}
    sets.midcast["Sentinel's Scherzo"] = {feet="Fili Cothrn. +1"}
    sets.midcast['Magic Finale'] = {neck="Incanter's torque",waist="Corvax Sash",legs="Fili Rhing. +1"}
    ...
    sets.midcast.SongEffect = {main="Carnwenhan",range="Gjallarhorn",
        head="Fili Calot +1",neck="Fili Matinee +1",ear2="Loquacious Earring",
