...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",
        ...
        head="Vanya Hood",neck="Orison Locket",ear1="Loquacious Earring",ear2="Mendicant's Earring",
        body="Shango Robe",hands="Chironic gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
        back="Swith Cape",waist="Channeler's Stone",legs="Doyen Pants",feet="Regal Pumps"}
        
    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})

    sets.precast.FC.Stoneskin = set_combine(sets.precast.FC['Enhancing Magic'], {legs="Doyen pants"})

    sets.precast.FC['Healing Magic'] = set_combine(sets.precast.FC, {main="Ababinili",sub="clerisy strap",legs="Ebers pantaloons"})
    ...
    sets.midcast.FastRecast = {main="Oranyan",sub="Vivid strap",ammo="Impatiens",
        ...
        back="Alaunus's cape",waist="Channeler's Stone",legs="Lengo Pants",feet="Regal pumps"}
    
    ------------ Cure sets-------------------

	sets.midcast.CureWithLightWeather = {main="Iridal Staff",sub="Achaq Grip",ammo="Hydrocera",
		head="Ebers cap",neck="Incanter's torque",ear1="Nourishing earring",ear2="Mendicant's earring",
		body="Ebers Bliaud",hands="Chironic gloves",ring1="Resonance Ring",ring2="Weatherspoon Ring",
		back="Tempered Cape",waist="Hachirin-no-obi",legs="Ebers Pantaloons",feet="Vanya clogs"}

    sets.midcast.CureSolace = {main="Queller Rod",sub="Sors Shield",ammo="Hydrocera",
        head="Vanya Hood",neck="Incanter's torque",ear1="Nourishing earring",ear2="Mendicant's Earring",
        body="Ebers bliaud",hands="Weatherspoon cuffs",ring1="Sirona's Ring",ring2="Haoma's Ring",
        back="Solemnity Cape",waist="Pythia Sash +1",legs="Ebers pantaloons",feet="Vanya Clogs"}

    sets.midcast.Cure = {main="Queller Rod",sub="Sors shield",ammo="Psilomene",
        head="Gendewitha Caubeen",neck="Incanter's torque",ear1="Mendicant's Earring",ear2="Glorious Earring",
        body="Kaykaus bliaut",hands="Weatherspoon cuffs",ring1="Sirona's Ring",ring2="Haoma's Ring",
        back="Solemnity Cape",waist="Pythia sash +1",legs="Ebers pantaloons",feet="Vanya clogs"}

    sets.midcast.Curaga = {main="Queller Rod",sub="Sors shield",ammo="Hydrocera",
        head="Gendewitha Caubeen",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Mendicant's Earring",
        body="Kaykaus bliaut",hands="Weatherspoon cuffs",ring1="Sirona's Ring",ring2="Weatherspoon Ring",
        back="Solemnity Cape",waist="Pythia sash +1",legs="Ebers pantaloons ",feet="Litany clogs"}

    sets.midcast.Cursna = {main="Ababinili +1",sub="Arbuda Grip",ammo="Impatiens",
        ...
        back="Tempered Cape",waist="Channeler's Stone",legs="Piety Pantaloons +1",feet="Vanya Clogs"}

    sets.midcast.StatusRemoval = {main="Ababinili",sub="Clemency Grip",ammo="Impatiens",
        head="Ebers cap",neck="Orison locket",ear1="Enchanter Earring +1",ear2="Loquacious Earring",
		body="Ebers bliaud",hands="Chironic gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
		back="Swith Cape",waist="Ninurta's Sash",legs="Ebers pantaloons",feet="Regal Pumps"}
...
--------------ENHANCING AND SUCH---------------------
    ...
    sets.midcast['Enhancing Magic'] = {main="Ababinili",sub="Clerisy Strap",
        ...
        back="Mending Cape",waist="Olympus Sash",legs="Ebers pantaloons",feet="Regal Pumps"}

	sets.midcast.Haste = set_combine(sets.midcast['Enhancing Magic'], 
		{ammo="Impatiens",
		neck="Voltsurge torque",ear1="Enchanter earring +1",ear2="Loquacious earring",
		ring1="Prolix ring",
		back="Swith cape",waist="Ninurta's sash"})
    ...
    sets.midcast.BarElement = {main="Ababinili",sub="Clerisy Strap",
        head="Ebers cap",neck="Incanter's Torque",ear1="Andoaa earring",
        body="Ebers bliaud",hands="Chironic gloves",
        back="Mending Cape",waist="Olympus Sash",legs="Ebers pantaloons",feet="Regal Pumps"}
    ...
    sets.idle = {main="Bolelabunga", sub="Sors Shield",ammo="Impatiens",
        head="Befouled Crown",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Thureous earring",
        body="Ebers Bliaud",hands="Chironic gloves",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Assiduity pants",feet="Vanya clogs"}

    sets.idle.PDT = {main="Bolelabunga", sub="Sors Shield",ammo="Impatiens",
        head="Befouled Crown",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Thureous earring",
        body="Ebers Bliaud",hands="Chironic gloves",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Assiduity pants",feet="Vanya clogs" }

	sets.idle.MDT = {main="Bolelabunga", sub="Sors Shield",ammo="Impatiens",
        head="Befouled Crown",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Thureous earring",
        body="Ebers Bliaud",hands="Chironic gloves",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Assiduity pants",feet="Vanya clogs"}


    sets.idle.Town = {main="Bolelabunga", sub="Sors Shield",ammo="Impatiens",
        head="Befouled Crown",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Thureous earring",
        body="Ebers Bliaud",hands="Chironic gloves",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Assiduity pants",feet="Crier's gaiters"}
    
    sets.idle.Weak = {main="Bolelabunga", sub="Sors Shield",ammo="Impatiens",
        head="Befouled Crown",neck="Incanter's torque",ear1="Nourishing Earring",ear2="Thureous earring",
        body="Ebers Bliaud",hands="Chironic gloves",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Assiduity pants",feet="Vanya clogs"}
