...
function init_gear_sets()
    ...
    sets.idle = {range="Compensator",ammo=gear.RAbullet,
        head="Rawhide Mask",neck="Loricate Torque +1",ear1="Flashward Earring",ear2="Spellbreaker Earring",
        body="Meghanada Cuirie",hands="Meghanada gloves",ring1=gear.DarkRing.PDT,ring2="Defending Ring",
        back="Camulus's Mantle",waist="Gishdubar sash",legs="Meghanada Chausses",feet="Meghanada Jambeaux" }
    
    sets.idle.PDT = {range="Compensator",ammo=gear.RAbullet,
        head="Meghanada Visor",neck="Loricate Torque +1",ear1="Sanare Earring",ear2="Infused Earring",
        body="Meghanada Cuirie",hands="Meghanada gloves",ring1=gear.DarkRing.PDT,ring2="Defending Ring",
        back="Solemnity Cape",waist="Gishdubar sash",legs="Meghanada Chausses",feet="Meghanada Jambeaux" }
    ...
    sets.defense.MDT = {
        head="Meghanada Visor",neck="Loricate Torque +1",ear1="Flashward Earring",ear2="Spellbreaker Earring",
        body="Meghanada Cuirie",hands="Meghanada gloves",ring1=gear.DarkRing.PDT,ring2="Defending Ring",
        back="Camulus's Mantle",waist="Gishdubar sash",legs="Meghanada Chausses",feet="Meghanada Jambeaux" }
