...
function init_gear_sets()
	...
	sets.precast.FC = {ammo="Sapience orb",
		main="Oranyan",sub="Clerisy Strap",
	...
	sets.midcast.FastRecast = {main="Oranyan",sub="Clerisy strap",ammo="Sapience Orb",
		head="Nahtirah Hat",neck="Orison locket",ear1="Enchanter earring +1",ear2="Loquacious Earring",
		body="Inyanga jubbah +1",hands="Fanatic gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
		back="Alaunus's cape",waist="Witful belt",legs="Lengo Pants",feet="Regal pumps"}
	...
	sets.midcast.Curaga = {main="Queller Rod",sub="Genmei shield",ammo="Psilomene",
		...
		back="Mending Cape",waist="Luminary Sash",legs="Ebers pantaloons +1",feet="Hygieia clogs +1"}
...
function job_post_precast(spell,action,spellMap,eventArgs)
	...
	-- if Lyna:contains(spell.english) and not buffactive[453] then
	-- 	eventArgs.cancel = true
	-- 	send_command('input /ja "Divine Caress" <me>;wait 1.5;input /ma "'..spell.name..'" '..spell.target.raw)
	-- end
	-- if player.sub_job == 'SCH' then
	...
	-- 			eventArgs.cancel = true
	-- 			send_command('@input /ja "accession" <me>;wait 1.5;input /ma "'..spell.name..'" '..spell.target.raw)
	-- 		end
	-- 	end
	-- end
end        
