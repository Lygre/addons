...
function init_gear_sets()
    ...
    sets.precast.FC = {main="Solstice",sub="Culminus",range="Dunna",ammo=empty,
        ...
        back="Lifestream Cape",waist="Witful Belt",legs="Geomancy Pants",feet=gear.MB_feet}

	sets.precast.FC.Stun = {main="Solstice",sub="Culminus",range=empty,ammo="Sapience orb",
    ...
    sets.midcast.FastRecast = {main="Solstice",sub="Culminus",range=empty,ammo="Sapience orb",
        head=gear.FC_head,neck="Voltsurge torque",ear1="loquacious earring",ear2="Enchanter earring +1",
        body="Shango robe",hands="Helios gloves",ring1="Prolix ring",ring2="Weatherspoon ring",
        back="Swith cape",waist="Ninurta's sash",legs="Geomancy Pants",feet=gear.nuke_feet}

	sets.midcast.Stun = {main="Solstice",sub="Culminus",range=empty,ammo="Sapience orb",
		head=gear.FC_head,neck="Voltsurge torque",ear1="Enchanter earring +1",ear2="Loquacious earring",
		body="Shango Robe",hands="Helios gloves",ring1="Prolix Ring",ring2="Weatherspoon Ring",
		back="Lifestream Cape",waist="Witful Belt",legs="Geomancy pants +1",feet=gear.MB_feet}


    sets.midcast.Geomancy = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
		head="Azimuth hood",neck="Incanter's Torque",ear1="Gifted Earring",ear2="Calamitous earring",
		body="Azimuth Coat",hands="Geomancy mitaines",
		back="Lifestream Cape",waist="Isa belt",legs="Azimuth tights",feet="Medium's sabots"}
    sets.midcast.Geomancy.Indi = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
		head="Azimuth Hood",neck="Incanter's torque",ear1="Gifted Earring",ear2="Calamitous earring",
		body="Bagua tunic",hands="Geomancy mitaines +1",
		back="Lifestream Cape",waist="Isa belt",legs="Bagua pants",feet="Azimuth gaiters"}
	...
	sets.midcast.Regen = set_combine(sets.midcast['Enhancing Magic'], {main="Bolelabunga",sub="Culminus",
		})
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity",sub="Culminus",range=empty,ammo="Pemphredo tathlum",
	...
	sets.midcast['Enfeebling Magic'] = {main="Solstice",sub="Culminus", ammo="Pemphredo tathlum",
	...
	sets.midcast.Impact = {main="Solstice",sub="Culminus",range=empty,ammo="Pemphredo Tathlum",
	...
	sets.magic_burst = {main="Solstice", sub="Culminus",
...
-----------------------------
    ...
    -- Resting sets
    sets.resting = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
    ...
    sets.idle = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
    ...
    sets.idle.PDT = {main="Solstice",sub="Culminus",range="Dunna",ammo=empty,
        head="Hagondes hat +1",neck="Loricate torque +1",ear1="Sanare Earring",ear2="Genmei Earring",
        body="Hagondes coat +1",hands="Geomancy Mitaines",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Solemnity Cape",waist="Slipor sash",legs="Psycloth lappas",feet="Azimuth gaiters"}

    -- .Pet sets are for when Luopan is present.
    sets.idle.Pet = {main="Solstice",sub="Culminus",range="Dunna",ammo=empty,
        head="Azimuth Hood",neck="Loricate torque +1",ear1="Handler's Earring",ear2="Handler's Earring +1",
        body="Amalric doublet",hands="Geomancy Mitaines",ring1="Defending Ring",ring2=gear.DarkRing.PDT,
        back="Lifestream cape",waist="Isa Belt",legs="Assiduity Pants",feet="Bagua Sandals"}
    ...
    sets.idle.PDT.Pet.Indi = set_combine(sets.idle.PDT.Pet, {feet="Azimuth gaiters"})

    sets.idle.Town = {main="Solstice",sub="Culminus",range="Dunna",ammo=empty,
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
    ...
    sets.defense.PDT = {main="Mafic Cudgel",sub="Culminus",range="Dunna",ammo=empty,
        head="Befouled crown",neck="Loricate torque +1",ear1="Sanare Earring",ear2="Genmei Earring",
    ...
    sets.defense.MDT = {main="Bolelabunga",sub="Culminus",range="Dunna",ammo=empty,
    ...
    -- Normal melee group
    sets.engaged = {main="Solstice",sub="Culminus",range="Dunna",ammo=empty,
