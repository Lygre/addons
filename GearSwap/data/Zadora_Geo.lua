...
--------------------------[Fast Cast sets]------------------------------
	...
	sets.precast.FC.Stun = set_combine(sets.precast.FC,
		...
		body="Shango Robe",hands={ name="Merlinic Dastanas", augments={'"Mag.Atk.Bns."+2','"Fast Cast"+6',}},ring1="Rahab Ring",ring2="Prolix Ring",
		back="Lifestream Cape",waist="Witful Belt",legs="Geomancy Pants +1",feet="Amalric Nails"})
 
	sets.precast.FC.Cure = set_combine(sets.precast.FC, {main="Serenity",sub="Clerisy Strap",
		body="Heka's Kalasiris",
		legs="Doyen pants",feet="Amalric Nails"})
...
--------------------------[Midcast sets]------------------------------
	...
	sets.midcast.Stun = set_combine(sets.precast.FC.Stun,{})
