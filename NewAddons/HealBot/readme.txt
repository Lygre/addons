...
"//hb bufflist listName targetName" command in data/buffLists.xml.  
The order of
...
editing data/priorities.xml.  
Note that detection of players' jobs is not
...
mabil_debuffs.xml.  
This list is woefully incomplete, but I plan on vastly
expanding it in the near future.  
If you decide to add any, I would greatly
appreciate it if you would share what you have added.  
If you add something, and
...
Activate
//hb off                            
Deactivate (note: follow will remain active)
